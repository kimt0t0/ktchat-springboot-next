...
// .content(
// "{ \"email\": \"toto@test.com\", \"username\": \"toto\", \"password\":
// \"Toto-123-\", \"role\\\": \"classic\" }"))
...
// .thenThrow(new UserAlreadyExistsException("A user account already exists with
// this email."));
...
// .contentType("application/json")
// .content(
// "{ \"email\": \"toto@test\", \"username\": \"\", \"password\": \"Toto\",
// \"role\\\": \"classic\" }"))
...
// when(userService.findById(any(UUID.class))).thenThrow(new
